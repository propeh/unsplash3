...
export const IconVisualSearch = () => (
    <svg width="32" height="32" className="_2o7Mr _2Jh5K _2_G8g" version="1.1" viewBox="0 0 32 32" aria-hidden="false">
...
export const IconSearchCollections = () => (
    <svg width="32" height="32" className="DhJsa" version="1.1" viewBox="0 0 32 32" aria-hidden="false">
...
export const IconPhotoDownload = () => (
